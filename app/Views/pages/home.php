      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
               <div class="shop">
                  <div class="shop-img">
                     <img src="./img/yasin1.jpg" alt="">
                  </div>
                  <div class="shop-body">
                     <h3>Cetak<br>Yasin</h3>
                     <a href="#" class="cta-btn">Order Sekarang <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
               </div>
            </div>
            <!-- /shop -->
            ...
            <div class="col-md-4 col-xs-6">
               <div class="shop">
                  <div class="shop-img">
                     <img src="./img/jilid.jpg" alt="">
                  </div>
                  <div class="shop-body">
                     <h3>Jilid<br>Laporan</h3>
                     <a href="#" class="cta-btn">Order Sekarang <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
               </div>
            </div>
               ...
               <div class="section-title">
                  ...
                  <div class="section-nav">
                     <ul class="section-tab-nav tab-nav">
                        <li class="active"><a data-toggle="tab" href="#tab1">ATK</a></li>
                        <li><a data-toggle="tab" href="#tab1">Digital Printing</a></li>
                        <li><a data-toggle="tab" href="#tab1">Foto Copy</a></li>
                        <li><a data-toggle="tab" href="#tab1">Cetak Brosur</a></li>
                     </ul>
                  </div>
               </div>
            </div>
